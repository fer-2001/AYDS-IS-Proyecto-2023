...
class User < ActiveRecord::Base
  ...
  def buy_card(card_number)
    ...
    save
    true # La compra fue exitosa

    # No se pudo comprar la carta debido a la falta de monedas
  end

  def set_card_by_name
    new_card_name = case card
    ...
    return unless new_card_name

    self.card = new_card_name
    save if changed? # Guarda el usuario solo si se cambió el nombre de la carta
  end
